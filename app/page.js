    ...
    <>
      <div className="text-white flex flex-col items-center justify-center h-[42vh] bg-gray-900 space-y-2">
        ...
        <div className="flex mt-4 gap-2">
          <Link href={"/login"}>
            <button type="button" className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-1 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Start Here</button>
          </Link>
          <button onClick={()=>{handleChange()}} type="button" className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-1 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">For Demo: Developer's Profile</button> 
        </div>
      </div>

      <div className="bg-white h-0.5 opacity-20 w-full"></div>

      <div className="text-white mx-auto container pb-16 px-4">
        <h2 className="text-2xl font-bold text-center my-4 mb-8">Your fans can buy you a chai..</h2>
        <div className="flex justify-around gap-4 md:gap-16 items-center">
